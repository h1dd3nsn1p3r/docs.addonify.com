	...
	return (
		...
		>
			<div className="flex relative">
				<Info size={22} className="inline-flex text-blue-600" />
				...
				<div className="ms-3 relative">
					...
					<div className="mt-3 block relative">
						<a
							...
							className="py-3 px-6 inline-flex items-center gap-2 text-base font-normal text-gray-600 border-2 border-gray-600 hover:text-blue-600 hover:border-blue-600 rounded-full transition-colors duration-300 ease-in"
						>
							Get premium
						</a>
					</div>
