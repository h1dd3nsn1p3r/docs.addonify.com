...
Hence, except custom button, none of the addonify quick view public assets gets initialized when disable on mobile is enabled & mobile user agent is detected. We are using this [open source library](https://github.com/serbanghita/Mobile-Detect) to detect the mobile device.
