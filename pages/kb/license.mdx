...
All our pro (aka. premium) products requires a valid license key to work. A valid license is also required to get bug fixes, updates, security patches, and support from our team. You are supposed to **renew the license subscription annually** to keep your product up-to-date unless you have a lifetime license. 
