...
<Tabs items={["v2.0.14 & above", "v2.0.13 & below", ]} defaultIndex="0">
  <Tabs.Tab>
		If you are using addonify wishlist version `2.0.14` or `above` then the JavaScript files are: 
		...
		```text
		http://domain.com/wp-content/plugins/addonify-wishlist/public/assets/build/guest.min.js
		```

		```text
		http://domain.com/wp-content/plugins/addonify-wishlist/public/assets/build/private.min.js
		```

		The `guest.min.js` file is for the guest user and the `private.min.js` file is for the logged-in user.
	</Tabs.Tab>
	<Tabs.Tab>
		If you are using addonify wishlist version `2.0.13` or `below` then the JavaScript files are: 
		...
		```text
		http://domain.com/wp-content/plugins/addonify-wishlist/public/assets/build/js/addonify-wishlist-public-guest.min.js
		```
	</Tabs.Tab>
</Tabs>
